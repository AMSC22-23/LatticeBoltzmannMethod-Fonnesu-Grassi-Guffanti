...
{
    node.set_population(1) = node.get_populations()[2] + two_thirds * node.get_rho() * node.get_u()[0];
    node.set_population(4) = node.get_populations()[3] - two_thirds * node.get_rho() * node.get_u()[1];
    node.set_population(8) = node.get_populations()[7] + one_sixth * node.get_rho() * (node.get_u()[0] - node.get_u()[1]);
...
{
    node.set_population(2) = node.get_populations()[1] - two_thirds * node.get_rho() * node.get_u()[0];
    node.set_population(4) = node.get_populations()[3] - two_thirds * node.get_rho() * node.get_u()[1];
    node.set_population(6) = node.get_populations()[5] - one_sixth * node.get_rho() * (node.get_u()[0] + node.get_u()[1]);
...
{
    node.set_population(1) = node.get_populations()[2] - two_thirds * node.get_rho() * node.get_u()[0];
    node.set_population(3) = node.get_populations()[4] - two_thirds * node.get_rho() * node.get_u()[1];
    node.set_population(5) = node.get_populations()[6] + one_sixth * node.get_rho() * (node.get_u()[0] + node.get_u()[1]);
