...
namespace llalbm::core::boundaries
{
    ...
    /**
     * @brief Generic bounce back with OMP parallelization
     * 
     * @tparam dim 
     */
    template<
    ...
    /**
     * @brief 2d specialization with OMP parallelization
     * 
     * @tparam  
     */
    template<>
    class OMPBounceBackPolicy<2> : public BoundaryPolicyTag, public OMPTag{
        ...
        public: 
            ...
            static void update_boundaries(Tensor<double, 3> &populations, std::vector<BoundaryPoint<2>> &boundary_coord, Tensor<double, 2> global_rho, Tensor<double, 3> global_u)
            {
                ...
                // OMP Directives to parallelize for loop, Private variables between threads specified
    ...
    /**
     * @brief Generic bounceback STD::Execution::par parallelization policy
     * 
     * @tparam dim 
     */
    template<
    ...
    /**
     * @brief 2d specialization with std::execution paralelization policy
     * 
     * @tparam  
     */
    template<>
    ...
    /**
     * @brief Generic bounce back with parallelization aimed for GPUs
     * 
     * @tparam dim 
     */
    template<
    ...
    /**
     * @brief 2d specialization bounce back with parallelization aimed for GPUs
     * 
     * @tparam dim 
     */
    template<>
