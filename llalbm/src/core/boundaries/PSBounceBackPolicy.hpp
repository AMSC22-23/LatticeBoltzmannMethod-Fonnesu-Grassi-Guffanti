...
template<
        std::size_t dim>
    class OpenACCPSBounceBackPolicy : public BoundaryPolicyTag, public OpenACCTag{
    private:
        /* data */
        Logger log;
    public:
        OpenACCPSBounceBackPolicy(/* args */)
        : log("Partially Saturated BB" , std::cout)
        {
            log.error("Partially Saturated BB not implemented");
            assert(false);
    ...
    template<>
    class OpenACCPSBounceBackPolicy<2> : public BoundaryPolicyTag, public OpenACCTag{
    ...
    double OpenACCPSBounceBackPolicy<2>::tau = 0.0;
}
