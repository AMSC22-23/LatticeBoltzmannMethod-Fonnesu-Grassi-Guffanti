...
namespace llalbm::core::collisions 
{
    ...
    template<std::size_t dim>
    class CUDATRTCollisionPolicy : public CollisionPolicyTag, public CUDATag
    {
    private:
        /// @brief Logger of the collision policy
        Logger l;
    ...
    template<>
    class CUDATRTCollisionPolicy<2> : public CollisionPolicyTag, public CUDATag
    {
    ...
    // initialization of the relaxation constants in the 2-D TRT collision operator(for CUDA class).
    double CUDATRTCollisionPolicy<2>::tau_even = 0.0;
    double CUDATRTCollisionPolicy<2>::tau_odd = 0.0;
    double CUDATRTCollisionPolicy<2>::sound_velocity = 0.0;
}; // namespace llalbm::core::collisions
