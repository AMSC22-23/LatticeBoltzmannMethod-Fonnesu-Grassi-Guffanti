...
/**
    ...
    /**
     * @brief CUDA version of the BGK collision operator.
     * 
     * @tparam dim the total number of spatial dimensions.
     */
    template<std::size_t dim>
    class CUDABGKCollisionPolicy : public CollisionPolicyTag, public CUDATag
    {
    private:
        /// @brief Logger of the collision policy
        Logger l;
    ...
    public:
        CUDABGKCollisionPolicy() 
        : l ("CUDA BGK", std::cout)
        {
            l.error("CUDA BGK COLLISION NOT IMPLEMENTED");
            assert(false);
        }
    };
    ...
    /**
     * @brief Specialization of the CUDA BGK collision operator for the 
     * use-case of two spatial dimensions.
     */
    template<>
    class CUDABGKCollisionPolicy<2> : public CollisionPolicyTag, public CUDATag
    {
    ...
    // initialization of the relaxation constant in the 2-D CUDA BGK collision operator.
    double CUDABGKCollisionPolicy<2>::tau = 0.0;
