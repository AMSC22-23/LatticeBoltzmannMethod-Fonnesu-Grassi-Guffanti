 ...
 * @brief Contains the MPI parallelization policy
 *  * 
 */

#ifndef LLALBM_MPIPOLICY_HPP
#define LLALBM_MPIPOLICY_HPP
...
namespace llalbm::core
{
    ...
    requires IsGloballyMPI<Configuration>
    class MPIPolicy : public MPITag{
    public:
        MPIPolicy() {
    ...
    class MPIPolicy<2, Configuration> : public MPITag{
    public:
