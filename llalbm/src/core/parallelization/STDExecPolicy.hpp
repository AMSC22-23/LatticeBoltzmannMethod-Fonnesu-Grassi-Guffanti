/**
 * @file STDExecPolicy.hpp
 * @author Lorenzo Fonnesu, Grassi Andrea
 * @brief Contains the standard parallelization policy, which is the easiest parallelization type
 *  * 
 */

#ifndef LLALBM_STDEXECPOLICY_HPP
#define LLALBM_STDEXECPOLICY_HPP
...
namespace llalbm::core
{
    ...
    requires IsGloballySTDExec<Configuration>
    class STDExecPolicy : public STDExecTag{
    public:
    ...
    class STDExecPolicy<2, Configuration> : public STDExecTag{
    public:
        static constexpr std::size_t dims = Configuration::dimensions;
