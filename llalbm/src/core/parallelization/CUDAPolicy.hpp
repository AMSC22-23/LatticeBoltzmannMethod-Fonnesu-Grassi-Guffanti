...
#ifndef LLALBM_CUDAPOLICY_HPP
#define LLALBM_CUDAPOLICY_HPP
...
namespace llalbm::core
{
    ...
    requires IsGloballyCUDA<Configuration>
    class CUDAPolicy : public CUDATag{
    public:
        CUDAPolicy() {
    ...
    class CUDAPolicy<2, Configuration> : public CUDATag{
    public:
