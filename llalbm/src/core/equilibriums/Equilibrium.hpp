...
namespace llalbm::core::equilibrium
{
    ...
    class Equilibrium<2>{
        ...
        static void calc_equilibrium(std::vector<Point<2>> &fluid_nodes, Tensor<double, 3> &populations, Tensor<double, 3> &equilibrium_populations, Tensor<double, 3> &global_u, Tensor<double,2> &global_rho){
